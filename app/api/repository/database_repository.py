...
class BaseRepository(Generic[ModelType], ABC):
    ...
    async def search_by_fields(self, search_fields: Dict[str, Any], 
                              fuzzy: bool = False, limit: Optional[int] = None) -> List[ModelType]:
        """
    ...
    async def search_by_any_field(self, search_fields: Dict[str, Any], 
                                 fuzzy: bool = False, limit: Optional[int] = None) -> List[ModelType]:
        """
...
class MultiTableRepository(ABC):
    ...
    @abstractmethod
    async def search_across_tables(self, search_criteria: Dict[str, Any]) -> Dict[str, List[Any]]:
        """
